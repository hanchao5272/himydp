...
/**
 * <p>第一个天气板，实现观察者和展示板接口</p>
 * @author hanchao 2018/4/30 21:16
 **/
public class CurrentConditionDisplay22 implements Observer22,Display22 {
    /* 温度*/
    ...
    public CurrentConditionDisplay22(Subject22 weatherData) {
    ...
    public String toString() {
        return "CurrentConditionDisplay22{" +
